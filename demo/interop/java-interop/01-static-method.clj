...
;; same syntax Clojure-on-the-JVM uses. Glojure resolves each `Math/*`
;; symbol to an internal bridge that forwards to gojava's Go port of
;; `java.lang.Math`. No import or aliasing is required.

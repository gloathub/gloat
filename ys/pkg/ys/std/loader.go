Compiling yamlscript.util to yamlscript/util/loader.go
Compiling yamlscript.common to yamlscript/common/loader.go
Warning: skipping invalid import: clojure.lang
Compiling ys.fs to ys/fs/loader.go
skipping host form: util/die
skipping host form: util/die
Compiling ys.ipc to ys/ipc/loader.go
Compiling ys.std to ys/std/loader.go
skipping host form: ys.http/get
skipping host form: util/atom?
ys.std
	...
	// curl
	{
		...
		tmp1 = lang.NewFnFunc(func(args ...any) any {
			...
			{ // let
				...
				_ = v6
				// let binding "resp"
				tmp7 := lang.Apply(nil, []any{v6})
				var v8 any = tmp7
				_ = v8
				var tmp9 any
				{ // let
					// let binding "temp__0__auto__"
					tmp10 := lang.Apply(kw_body, []any{v8})
					var v11 any = tmp10
					_ = v11
					var tmp12 any
					if lang.IsTruthy(v11) {
						...
						tmp14 := checkDerefVar(var_yamlscript_DOT_util_die)
